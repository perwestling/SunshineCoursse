...
public class TestDb extends AndroidTestCase {
    ...
    */
    ...
    public void testWeatherTable() {
        ...
        assertTrue("Is non-negative if row found", rowId >= 0);

        Cursor cursor = db.query(WeatherContract.WeatherEntry.TABLE_NAME, null, null, null, null, null, null);

        assertTrue("Should have moved to first", cursor.moveToFirst());

        TestUtilities.validateCursor("Invalid row content", cursor, weatherValue);

        assertFalse("Should have no more records", cursor.moveToNext());
    ...
    public long insertLocation(SQLiteDatabase db) {
        ...
        long rowId = db.insert(LocationEntry.TABLE_NAME, null, locationValue);
        assertTrue("Is non-negative if row found", rowId >= 0);
        ...
        TestUtilities.validateCursor("Invalid row content", cursor, locationValue);
